 ...
 * https://pglezen.github.io/was-config/html/soapui.html
 *
 * @author SKAT
 * @since 1.0
 */
...
public class USKoeretoejRegistreringHentClient {
    ...
    public void invoke(String registreringNummerNummer) throws DatatypeConfigurationException, ParserConfigurationException, IOException, SAXException {
        ...
        port.getUSKoeretoejRegistreringHent(usKoeretoejTekniskDataHentIType);
    ...
    public static void main(String[] args) {
        ...
        USKoeretoejRegistreringHentClient client = new USKoeretoejRegistreringHentClient("https://dmrsit1gateway1.skat.dk/B2B/USForsikring/Service?WSDL");
        try {
            client.invoke("BJ68632");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
